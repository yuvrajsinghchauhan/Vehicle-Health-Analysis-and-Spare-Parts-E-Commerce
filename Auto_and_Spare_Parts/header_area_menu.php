                ...
                <li><a href="cat_product_select_sh.php?id=<?php echo $cat_p_id; ?>"> <?php echo $cat_title; ?> </a></li>
                            ...
                            ?>
                                    ...
                                    <!--
                                     ...
                                     <li><a href="all_product_sh.php"> <?php // echo $cat_title; ?> </a></li>

                                        <li><a href="all_product_sh.php"> Accessories</a></li>
                                        <li><a href="all_product_sh.php">Body Parts</a></li>
                                        <li><a href="all_product_sh.php">Car Engine</a></li>
                                        <li><a href="all_product_sh.php">Interiors</a></li>
                                        <li><a href="all_product_sh.php">Lights & Lamp</a></li>
                                        <li><a href="all_product_sh.php">Repair Parts</a></li>
                                        <li><a href="all_product_sh.php">Wheel & Tires</a></li>
                                        <li><a href="all_product_sh.php">Smart Devices</a></li>
                                        <li><a href="all_product_sh.php">Exteriors</a></li>
